<template>
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark bg-secondary">
	<div class="navbar-header d-flex col">
		<a class="navbar-brand" href="#"><i class="fa fa-instagram"></i>Instagram</a>
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
      ...
      <nuxt-link to="/private" class=" nav-link" ><i class="fa fa-home"></i><span>Home</span></nuxt-link>
      </li>
      ...
      <li class="nav-item active">
      <nuxt-link to="/private/profile" class=" nav-link" ><i class="fa fa-user"></i><span>Profile</span></nuxt-link>
      </li>
			<li class="nav-item"><a href="#" class="nav-link"><i class="fa fa-gears"></i><span>Parametres</span></a></li>
